...
/* Based on multi-dvorak.
 *
 * I use a shift hack in Karabiner to remap `; -> :`. This remapping should be
 * applied directly in hard Dvorak.
 */
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KEYMAP(KC_1, SHIFT(KC_2), KC_UP, SHIFT(KC_MINS), SHIFT(KC_EQUAL), \
  ...
  KEYMAP(SHIFT(KC_INS), KC_HOME, KC_UP, KC_END, KC_PGUP, KC_UP, KC_F7, KC_F8, KC_F9, KC_F10, \
  ...
  /* 3: hard dvorak */
  KEYMAP(SHIFT(KC_SCLN), KC_COMM, KC_DOT, KC_P, KC_Y, KC_F, KC_G, KC_C, KC_R, KC_L, \
